...
import com.yus.wenda_beta_2.pojo.TicketExample.Criteria;
import com.yus.wenda_beta_2.pojo.TicketExample.Criterion;
...
public class TicketSqlProvider {
    ...
    public String insertSelective(Ticket record) {
        ...
        if (record.getExpired() != null) {
            VALUES("expired", "#{expired,jdbcType=TIMESTAMP}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getTicket() != null) {
            SET("ticket = #{record.ticket,jdbcType=VARCHAR}");
        }
        
        if (record.getExpired() != null) {
            SET("expired = #{record.expired,jdbcType=TIMESTAMP}");
        }
