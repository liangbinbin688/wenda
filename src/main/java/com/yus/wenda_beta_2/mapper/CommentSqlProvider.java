...
import com.yus.wenda_beta_2.pojo.CommentExample.Criteria;
import com.yus.wenda_beta_2.pojo.CommentExample.Criterion;
...
public class CommentSqlProvider {
    ...
    public String insertSelective(Comment record) {
        ...
        if (record.getEntityId() != null) {
            VALUES("entity_id", "#{entityId,jdbcType=INTEGER}");
        }
        
        if (record.getEntityType() != null) {
            VALUES("entity_type", "#{entityType,jdbcType=INTEGER}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getEntityType() != null) {
            SET("entity_type = #{record.entityType,jdbcType=INTEGER}");
        }
